  ...
  return {
    ...
    createProject (projectName) {
      ...
      db.prepare(
        ...
        project.subtitleCutsJson, project.splitDraftJson, project.inVideoTitle, project.parentProjectId, project.episodeIndex,
    ...
    updateProject (id, patch) {
      ...
      db.prepare(
        `UPDATE projects SET
          ...
          subtitle_cuts_json = ?, split_draft_json = ?, in_video_title = ?, parent_project_id = ?, episode_index = ?,
