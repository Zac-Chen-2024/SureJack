...
function makeProject (patch: Partial<Project> = {}): Project {
  return {
    ...
    subtitleFontSize: 64, coverTitle: '', watermarkText: '', openingPickJson: '', openingState: 'settled' as const, subtitleCutsJson: '', splitDraftJson: '', voiceGain: 1, inVideoTitle: '', parentProjectId: null, episodeIndex: 1, voiceName: 'zh-CN-XiaoxiaoNeural', voiceRate: 0, voiceVolume: 0, voicePitch: 0, subtitleMarginV: DEFAULT_SUBTITLE_MARGIN_V,
